						...
						<table class="table table-striped">
								...
								<tbody>
									...
									<tr>
										...
										<td><?= $m['password']?></td>
										<td>
											<a href="<?= base_url()?>User/hapus/<?= $m['userid']?>" class=" btn btn-sm btn-dark"><i class="fa fa-trash"></i></a>
											<a href="<?= base_url()?>User/edit/<?= $m['userid']?>" class=" btn btn-sm btn-success"><i class="fa fa-edit"></i></a>
										</td>
									</tr>
									<?php endforeach;?>
							</tbody>
